...
import ISwapPair from '@uniswap/v2-core/build/IUniswapV2Pair.json'
import SwapFactory from '@uniswap/v2-core/build/UniswapV2Factory.json'
import SwapRouter from '@uniswap/v2-periphery/build/UniswapV2Router02.json'
